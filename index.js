...
function sortByPricing(pricing) {
...
app.get("/hotels/sort/pricing", (req, res) => {
  ...
  let result = hotels.sort(sortByPricing(pricing));
  res.json({ hotels: result });
});

//Get the hotels sorted based on their Ratings
function sortByRatings(rating, hotel1, hotel2) {
...
app.get("/hotels/sort/rating", (req, res) => {
  ...
  let result = hotels.sort((hotel1, hotel2) =>
    sortByRatings(rating, hotel1, hotel2),
  );
  res.json({ hotels: result });
});

//Get the Hotels sorted based on their Reviews
function sortByReviews(reviews, review1, review2) {
...
app.get("/hotels/sort/reviews", (req, res) => {
  ...
  let result = hotels.sort((review1, review2) =>
    sortByReviews(reviews, review1, review2),
  );
  res.json({ hotels: result });
});
